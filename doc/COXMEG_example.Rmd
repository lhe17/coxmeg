...
The current version provides five functions.
  ...
  *  `coxmeg_gds`: Perform a GWAS using a GDS file. Read more details [here](../doc/coxmeg_gds_example.html).
